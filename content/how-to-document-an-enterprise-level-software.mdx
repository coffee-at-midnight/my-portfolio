...
Don't worry your favorite technical writer has all the right advice for you!
...
For this you need to set up a system that allows you to organize the documentation in a structured way, as well as allows users to navigate it intuitively and swiftly find the information they're looking for.
...
![GIF](https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExN2g0aTc0djN5MmhxMGJwb2ZybThiY3I4anB3aTUybWJvaTF3ajh0NCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/yB22VAMAY8XNS/giphy.gif)
<Caption>Sweetie.</Caption>
...
DITA/XML is industry standard for a reason because it provides technical writers with a concrete information architecture to organize the content and a complementing format to convert this architecture into a highly structured documentation.
...
And whether the refusal to opt for any kind of commercial solution (due to aforementioned resource allocation issue) might not actually increase costs and hassle for everybody involved.

## To summarize things

So, here's what you need to document an enterprise-level software:

- First of all, you need the content for the documentation in a structured format, organized according to some kind of information architecture (content layer).
